...
import com.example.sipo.infograff.modulMap.DataParser;
...
public class MapsSpot extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_spot);
        ...
        googleApiClient = new GoogleApiClient.Builder(this)
                ...
                .build();
        fab = (FloatingActionButton) findViewById(R.id.fabdirection);
        ...
        origin = new LatLng(mylat, mylong);
